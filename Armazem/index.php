                    ...
                    <article class="detalhes">
                        ...
                        <a href="requisita.php">
                            <div class="top">
                                ...
                                <div class="desc">
                                    <h4 class="title">Requisições Ferramentas</h4>
                                    <p><?=$totalR?></p>
                                </div>
                            </div> 
                            <div class="bottom">
                                <p>Total Requisições Ferramentas</p>
                            </div>
                        </a>
                        <a href="Notificacoes.php">
                            <div class="top">
                                ...
                                <div class="desc">
                                    <h4 class="title">Notificações Material</h4>
                                    <p><?=$not ?></p>
                                </div>
                            </div> 
                            <div class="bottom">
                        ...
                        <a href="#">
                            <div class="top">
                                ...
                                <div class="desc">
                                    <h4 class="title">Notificações Mensagens</h4>
                                    <p>0</p>
                                </div>
                            </div> 
                            <div class="bottom">
                                <p>Notificações Mensagens</p>
                            </div>
                        </a>
                </article>
            </section>
