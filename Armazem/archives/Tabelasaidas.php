                ...
                if($cmd->rowCount() > 0){
                    foreach($dados as $s){ 
                            ...
                            <tr>
                                ...
                                <td>'.$s['quantidade'].'</td>
                                <td>'.$s['data'].'</td>
                                <td title="Detalhes do Produto"><a href="detalhesSaida.php?id='.$s['id'].'" class="btn btn-info btn-sm"><i class="fa-solid fa-info"></i></a></td>
                                <td title="Editar o Produto"><a href="addsaida.php?id='.$s['id'].'" class="btn btn-primary btn-sm"><i class="fa-solid fa-edit"></i></a></td>
                            </tr>
                            ';
                    }
                }else{
