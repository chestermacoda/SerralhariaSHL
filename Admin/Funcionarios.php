...
<body>
    <div class="conteiner">
            ...
            <section >
                <h2 class="h2">Listas de Funcionarios</h2>
                <div class="menu">
                    <a href="relatorio_dompdf/FuncionariosPrint.php" class="btn btn-primary"><i class="fa-solid fa-print"></i></a>
                </div>
    ...
    <script>var url = "archives/TabelaFuncio.php";</script>
